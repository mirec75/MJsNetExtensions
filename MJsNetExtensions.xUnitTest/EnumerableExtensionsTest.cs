...
namespace MJsNetExtensions.xUnitTest
{
    ...
    public class EnumerableExtensionsTest
    {
        ...
        private static readonly List<string> _dummyNullsAndEmptyStrings = new List<string>
        {
            null,
            "",
            " ",
        ...
        private static readonly List<string> _dummyNullsEmptyAndFilledStrings = new List<string>
        {
            null,
            "",
            " ",
        ...
        private static readonly List<DummyPerson> _dummyNullPersons = new List<DummyPerson>
        {
            null,
            null,
            null,
        };
        private static readonly List<DummyPerson> _dummyNullsAndPersons = new List<DummyPerson>
        {
            new DummyPerson
            {
                Id = 1,
        ...
        {
            // Arrange
            IEnumerable<string> myCollection = Array.Empty<string>();
        ...
        {
            // Arrange
            IEnumerable<DummyPerson> myCollection = Array.Empty<DummyPerson>();

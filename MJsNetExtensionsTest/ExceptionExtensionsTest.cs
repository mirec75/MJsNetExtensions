...
namespace MJsNetExtensionsTest
{
    ...
    public class ExceptionExtensionsTest
    {
        ...
        {
            // Arrange:
            Exception ex = new AggregateException("I'm aggregated msg", new Exception[]
            {
        ...
        public void ExceptionJoinMessagesTest2_ExpectSuccess()
        {
            ...
            // Assert:
            Assert.AreEqual("I'm aggregated msg --> Don't go to net now --> So invalid --> wanna reach infinity?! --> It's simply good hidden --> Ga ga u lala!", ret);
        }
        ...
        public void ExceptionJoinMessagesTest3_ExpectSuccess()
        {
            ...
            Exception ex = new ArgumentOutOfRangeException(
                "paramFefe",
                new AggregateException("I'm aggregated msg", new Exception[]
                {
                    new WebException("Don't go to net now", new InvalidOperationException("So invalid", new DivideByZeroException("wanna reach infinity?!"))),
                    new FileNotFoundException("It's simply good hidden", "foo.txt"),
                    new Exception("Ga ga u lala!"),
            ...
            // Assert:
            Assert.AreEqual("paramFefe --> I'm aggregated msg --> Don't go to net now --> So invalid --> wanna reach infinity?! --> It's simply good hidden --> Ga ga u lala!", ret);
        }
        ...
        public void ExceptionJoinMessagesTest4_ExpectSuccess()
        {
            ...
            Assert.AreEqual("aggreging it all --> divisorOfX --> Attempted to divide by zero.", ret);
        ...
        public void ExceptionJoinMessagesWithTypesTest2_ExpectSuccess()
        {
            ...
            // Assert:
            Assert.AreEqual(
                "AggregateException: I'm aggregated msg --> WebException: Don't go to net now --> InvalidOperationException: So invalid --> DivideByZeroException: wanna reach infinity?! --> FileNotFoundException: It's simply good hidden --> Exception: Ga ga u lala!", 
                ret
                );
        }
        ...
        public void ExceptionJoinMessagesWithTypesTest3_ExpectSuccess()
        {
            ...
            // Assert:
            Assert.AreEqual(
                "ArgumentOutOfRangeException: paramFefe --> AggregateException: I'm aggregated msg --> WebException: Don't go to net now --> InvalidOperationException: So invalid --> DivideByZeroException: wanna reach infinity?! --> FileNotFoundException: It's simply good hidden --> Exception: Ga ga u lala!",
                ret
                );
        }
        ...
        public void ExceptionJoinMessagesWithTypesTest4_ExpectSuccess()
        {
            ...
            // Assert:
            bool equals =
                string.Compare("AggregateException: aggreging it all --> ArgumentOutOfRangeException: divisorOfX --> DivideByZeroException: Es wurde versucht, durch 0 (null) zu teilen.", ret, StringComparison.OrdinalIgnoreCase) == 0 ||
                string.Compare("AggregateException: aggreging it all --> ArgumentOutOfRangeException: divisorOfX --> DivideByZeroException: Attempted to divide by zero.", ret, StringComparison.OrdinalIgnoreCase) == 0
                ;

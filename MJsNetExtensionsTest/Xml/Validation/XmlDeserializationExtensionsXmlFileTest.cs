namespace MJsNetExtensionsTest.Xml.Validation
{
    ...
    [TestClass]
    public class XmlDeserializationExtensionsXmlFileTest
    {
        #region Properties
        ...
        public void XmlDeserializationLoadXmlToTest1_ExpectSuccess()
        {
            ...
            // Act:
            customerOrder deserialized = xmlFilePath.LoadXmlTo<customerOrder>();
        ...
        public void XmlDeserializationLoadXmlToParamTest1_ExpectException()
        {
            ...
            // Act:
            Assert.ThrowsExactly<InvalidOperationException>(() => xmlFilePath.LoadXmlTo<customerOrder>());
        }

        [TestMethod]
        public void XmlDeserializationLoadXmlToParamTest2_ExpectException()
        {
            // Arrange:
            string xmlFilePath = null;

            // Act:
            Assert.ThrowsExactly<ArgumentNullException>(() => xmlFilePath.LoadXmlTo<customerOrder>());
        }
        ...
        [TestMethod]
        public void XmlDeserializationLoadXmlToParamTest4_ExpectException()
        {
            // Arrange:
            string xmlFilePath = " \r  \t  \n ";
        ...
        [TestMethod]
        public void XmlDeserializationLoadXmlToParamTest5_ExpectException()
        {
            // Arrange:
            string xmlFilePath = Path.Combine(CommonStatics.__programDirectory, "foobar.xml");
        ...
        [TestMethod]
        public void XmlDeserializationLoadXmlToParamTest6_ExpectException()
        {
            // Arrange:
            string xmlFilePath = Path.Combine(CommonStatics.__programDirectory, "foobar.xml");
        ...
        [TestMethod]
        public void XmlDeserializationLoadXmlToParamTest7_ExpectException()
        {
            // Arrange:
            string xmlFilePath = Path.Combine(CommonStatics.__programDirectory, "foobar.xml");
        ...
        public void XmlDeserializationTryLoadXmlToAndValidateNOSettingsTest1_ExpectOpFailure()
        {
            ...
            // Act:
            OperationResult<customerOrder> operationResult = xmlFilePath.TryLoadXmlToAndValidate<customerOrder>();
        ...
        public void XmlDeserializationTryLoadXmlToAndValidateWITHSettingsTest1_ExpectSuccess()
        {
            ...
            OperationResult<customerOrder> operationResult =
                xmlFilePath
                .TryLoadXmlToAndValidate<customerOrder>(

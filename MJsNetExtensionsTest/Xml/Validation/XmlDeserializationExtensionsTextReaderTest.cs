namespace MJsNetExtensionsTest.Xml.Validation
{
    ...
    [TestClass]
    public class XmlDeserializationExtensionsTextReaderTest
    {
        ...
        public void XmlDeserializationLoadXmlToTest1_ExpectSuccess()
        {
            ...
            using (var stream = IOHelpers.GetMemoryStreamFromFile(xmlFilePath))
                deserialized = stream.XmlTo<customerOrder>();
        ...
        public void XmlDeserializationLoadXmlToParamTest3_ExpectException()
        {
            ...
            // Act:
            ((Stream)null).XmlTo<customerOrder>();
        ...
        public void XmlDeserializationTryLoadXmlToAndValidateNOSettingsTest1_ExpectOpFailure()
        {
            ...
            using (var stream = IOHelpers.GetMemoryStreamFromFile(xmlFilePath))
                operationResult = stream.TryReadXmlToAndValidate<customerOrder>();

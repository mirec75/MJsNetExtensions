...
namespace MJsNetExtensionsTest.Xml.Serialization
{
    ...
    public class XmlSerializationExtensionsParamsTest
    {
        ...
        public void ToXmlXSREBNullParam2_ExpectSuccess()
        {
            ...
            // Act:
            string outputString = response.ToXml((XmlToStringSerializationSettings)null);
        ...
        public void ToXmlObjNullParam5_ExpectException()
        {
            ...
            // Act:
            response.ToXml((TextWriter)null);
        ...
        public void TryToXmlXSREBNullParam1_ExpectSuccess()
        {
            ...
            bool equals =
                string.Compare("ArgumentNullException: Der Wert darf nicht NULL sein.\r\nParametername: toSerialize", result.FailureMessage, StringComparison.OrdinalIgnoreCase) == 0 ||
                string.Compare("ArgumentNullException: Value cannot be null.\r\nParameter name: toSerialize", result.FailureMessage, StringComparison.OrdinalIgnoreCase) == 0
                ;

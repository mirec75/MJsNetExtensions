namespace MJsNetExtensionsTest.Xml.Serialization.TestClasses2
{
    ...
    /// </summary>
    public class CommonExLogDataTest2 : CommonLogDataTest2
    {
        #region Dummy Factories

        internal static CommonExLogDataTest2 GetNewCommonExLogData()
        {
            return new CommonExLogDataTest2
            {
                InsertStoredProcedureName = "ChOrLogInsert", // same as: "dbo.ChCcLogInsert", or "[dbo].[ChCcLogInsert]"
                ...
                Details = CommonLogDataTest2.GetnewDetailsLogDataList(),

                Orders = GetnewOrdersLogDataList(),
            };
        }

        internal static List<OrdersLogDataTest2> GetnewOrdersLogDataList()
        {
            return new List<OrdersLogDataTest2>
            {
                new OrdersLogDataTest2
                {
                    Id = 777,
                    LogId = 123,
                    OrderNo = 457,
        ...
        public List<OrdersLogDataTest2> Orders { get; set; } = new List<OrdersLogDataTest2>();
        ...
        public override void PreStructureValidationAndUpdate(ValidationResult validationResult)
        {
            base.PreStructureValidationAndUpdate(validationResult);

            validationResult
                .ThrowIfNull(nameof(validationResult))
                .InvalidateIfNullOrWhiteSpace(this.Reference, nameof(this.Reference));
        }
        ...
        /// </summary>
        /// <param name="validationResult"><see cref="ValidationResult"/></param>
        public override void PostStructureValidationAndUpdate(ValidationResult validationResult)
        {
            base.PostStructureValidationAndUpdate(validationResult);
        }
        ...
        {
            return this.Equals(obj as CommonExLogDataTest2);
        }

        /// <summary>
        /// Determines whether the specified <see cref="CommonExLogDataTest2"/> is equal to this instance.
        /// </summary>
        /// <param name="that">The that.</param>
        /// <returns>True if the given <see cref="CommonExLogDataTest2"/> equals this instance</returns>
        public bool Equals(CommonExLogDataTest2 that)
        {
            ...
            if (!base.Equals(that as CommonLogDataTest2))
            {
                return false;
            }
            ...
            if (string.Compare(this.Reference, that.Reference, StringComparison.OrdinalIgnoreCase) != 0)
            {
                return false;
            }
        ...
        {
            int hash = (this.Reference ?? "").GetHashCode();

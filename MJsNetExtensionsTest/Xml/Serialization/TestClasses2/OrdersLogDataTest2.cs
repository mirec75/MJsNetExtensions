namespace MJsNetExtensionsTest.Xml.Serialization.TestClasses2
{
    ...
    /// <summary>
    /// Summary description for OrdersLogDataTest2
    /// </summary>
    public class OrdersLogDataTest2 : ISimpleValidatable
    {
        #region Properties
        ...
        public int PosCountRequest { get; set; } = 0;

        public int PosCountResponse { get; set; } = 0;
        ...
        public void PreStructureValidation(ValidationResult validationResult)
        {
            validationResult
                ...
                .InvalidateIf(this.OrderNo == 0, "{0} not provided", nameof(this.OrderNo));
        ...
        {
            return this.Equals(obj as OrdersLogDataTest2);
        }

        /// <summary>
        /// Determines whether the specified <see cref="OrdersLogDataTest2"/> is equal to this instance.
        /// </summary>
        /// <param name="that">The that.</param>
        /// <returns>True if the given <see cref="OrdersLogDataTest2"/> equals this instance</returns>
        public bool Equals(OrdersLogDataTest2 that)
        {

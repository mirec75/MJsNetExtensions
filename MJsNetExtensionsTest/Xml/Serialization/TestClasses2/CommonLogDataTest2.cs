namespace MJsNetExtensionsTest.Xml.Serialization.TestClasses2
{
    ...
    public class CommonLogDataTest2 : IValidatableAndUpdatable
    {
        ...
        public List<DetailsLogDataTest2> Details { get; set; } = new();
        ...
        public override int GetHashCode()
        {
            ...
            hash ^= (this.UserName ?? "").GetHashCode(StringComparison.Ordinal);
            hash ^= (this.Request ?? "").GetHashCode(StringComparison.Ordinal);
            hash ^= (this.Response ?? "").GetHashCode(StringComparison.Ordinal);
            hash ^= (this.ResultLevel ?? "").GetHashCode(StringComparison.Ordinal);
            hash ^= (this.ResultMessage ?? "").GetHashCode(StringComparison.Ordinal);
            hash ^= this.ItemCountRequest.GetHashCode();
            hash ^= this.ItemCountResponse.GetHashCode();
            hash ^= (this.FrontendServer ?? "").GetHashCode(StringComparison.Ordinal);
            hash ^= (this.BackendServer ?? "").GetHashCode(StringComparison.Ordinal);
            hash ^= this.ProcessId.GetHashCode();
            hash ^= this.ThreadId.GetHashCode();
            hash ^= (this.Version ?? "").GetHashCode(StringComparison.Ordinal);

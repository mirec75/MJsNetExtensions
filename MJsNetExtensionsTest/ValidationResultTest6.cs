namespace MJsNetExtensionsTest
{
    ...
    public partial class ValidationResultTest
    {
        ...
        public void ValidationResultIntegrateOptionalSubResult1_ExpectSuccess()
        {
            ...
            string dfltSeparator = ValidationResultTest.DefaultSeparator;
        ...
        {
            public const string ErrMsg = "Dummy invalid reason.";
            public static readonly string ExpectedPrefix = $"Invalid {typeof(InvalidValidatable).Name}: ";

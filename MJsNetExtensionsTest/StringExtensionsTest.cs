...
namespace MJsNetExtensionsTest
{
    ...
    public class StringExtensionsTest
    {
        ...
        public void ToCsvLineTest1_ExpectSuccess()
        {
            // Arrange:
            // Act:
            string result = new string[] { "" }.ToCsvLine();
        ...
        public void ToCsvLineTest2_ExpectSuccess()
        {
            // Arrange:
            // Act:
            string result = new string[] { "", "" }.ToCsvLine(null);
        ...
        public void ToCsvLineTest4_ExpectSuccess()
        {
            // Arrange:
            // Act:
            string result = new string[] { "haha", "hihi" }.ToCsvLine(",");
        ...
        public void ToCsvLineTest5_ExpectSuccess()
        {
            // Arrange:
            // Act:
            string result = new string[] { "haha", "hihi" }.ToCsvLine("BRUM");

namespace MJsNetExtensions.Xml.Validation
{
    ...
    public class XmlValidationIssue
    {
        ...
        /// <param name="xmlFile">The XML file beeingvalidated</param>
        ...
        internal static XmlValidationIssue Create(XmlReader reader, ValidationEventArgs args, string xmlFile, bool hasDefinitionFile)
        {
            ...
            {
                if (args.Message.Contains(DoNotGoToWebXmlResolver.CannotResolveUri) ||
                    args.Message.Contains(DoNotGoToWebXmlResolver.ResolvedUriAlreadyLoaded)
                    )
                {
            ...
            if (validationException != null)
            {
                if (!string.IsNullOrWhiteSpace(validationException.SourceUri))
                {
                    ...
                    if (string.Compare(xmlFile, sourceUri.LocalPath, StringComparison.OrdinalIgnoreCase) != 0)
                    {
        ...
        /// </summary>
        internal string AttributeLocalName { get; private set; } = null;
        ...
        /// </summary>
        public ValidationSeverity Severity { get; private set; } = default(ValidationSeverity);

        /// <summary>
        /// Gets the XmlFile.
        /// </summary>
        public string XmlFile { get; private set; } = null;
        ...
        /// <summary>
        /// Gets the XPath reated to this issue.
        /// </summary>
        public string XPath { get; internal set; } = null;

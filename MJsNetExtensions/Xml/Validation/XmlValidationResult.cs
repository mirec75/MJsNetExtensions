namespace MJsNetExtensions.Xml.Validation
{
    ...
    public sealed class XmlValidationResult : IValidationResult
    {
        ...
        private List<XmlValidationIssue> xmlValidationIssues = new List<XmlValidationIssue>();
        ...
        /// </summary>
        public IEnumerable<string> KnownDefinitionFiles { get; private set; } = new string[0];
        ...
        /// </summary>
        public int WarningsCount { get; internal set; } = 0;

        /// <summary>
        /// Flag indicating if an exception occurred during validation.
        /// </summary>
        public bool WasException { get; internal set; } = false;
        ...
        /// </summary>
        public string InvalidReasonPrefix { get { return this.ValidationResultMessage; } set { /* ignore */ } }

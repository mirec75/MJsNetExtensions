...
namespace MJsNetExtensions.ObjectValidation
{
    ...
    public class ValidationPreAndPostProcessItemHandler<T> : IPreAndPostProcessItemHandler<T>
    {
        ...
        private Action<T, ValidationResult> preProcessItem = null;
        private Action<T, ValidationResult> postProcessItem = null;
        ...
        /// </summary>
        public T ValidatableRoot { get; private set; } = default(T);
        ...
        /// </summary>
        public ValidationSettings Settings { get; private set; } = new ValidationSettings();
        ...
        /// </summary>
        public Exception CustomException { get; private set; } = null;

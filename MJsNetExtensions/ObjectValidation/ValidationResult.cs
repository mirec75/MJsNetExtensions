namespace MJsNetExtensions.ObjectValidation
{
    ...
    public class ValidationResult : IValidationResult
    {
        ...
        private string nameOfRoot = null;
        private string invalidReasonPrefix = null;
        ...
        /// </summary>
        public string CallerTypeName { get; private set; } = null;
        ...
        {
            get { return this.invalidReasonPrefix; }
            set
            {
                if (string.IsNullOrWhiteSpace(value))
                {
        ...
        /// </summary>
        public string CurrentObjectPath { get; set; } = null;

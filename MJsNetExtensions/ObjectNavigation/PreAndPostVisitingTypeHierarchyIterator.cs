namespace MJsNetExtensions.ObjectNavigation
{
    ...
    public class PreAndPostVisitingTypeHierarchyIterator<T>
    {
        ...
        private static ConcurrentDictionary<PublicNonPublicSettings, List<PropertyInfo>> settingsWithTypeToPropertyInfoDict = new ConcurrentDictionary<PublicNonPublicSettings, List<PropertyInfo>>();
        private static ConcurrentDictionary<PublicNonPublicSettings, List<FieldInfo>> settingsWithTypeToFieldInfoDict = new ConcurrentDictionary<PublicNonPublicSettings, List<FieldInfo>>();
        ...
        private PublicNonPublicSettings propertiesSettings = null;
        private PublicNonPublicSettings fieldsSettings = null;
        ...
        private TypeHierarchyIteratorSettings Settings { get; set; } = new TypeHierarchyIteratorSettings();

        private IPreAndPostProcessItemHandler<T> PreAndPostProcessItemHandler { get; set; } = null;
        ...
        /// </summary>
        private HashSet<T> ProcessedItems { get; } = new HashSet<T>();
        ...
        /// </summary>
        private HashSet<T> ItemsReservedForProcessing { get; } = new HashSet<T>();
        ...
        /// </summary>
        private bool StopProcessing { get; set; } = false;
        ...
        private bool CollectChildrenToProcess(HierarchyPathItem<T> parentPathItem, Type valueType, Func<object> valueGetter, string childName, List<HierarchyPathItem<T>> childrenToProcess)
        {
            ...
            {
                int ii = 0;
                foreach (T subComponent in valueGetter() as IEnumerable<T> ?? new T[0])
                {
            ...
            {
                var enumerable = valueGetter() as IEnumerable;
                if (enumerable != null)
                {
                    int ii = 0;
        ...
        private IEnumerable<PropertyInfo> GetNonSimpleProperties(object propertiesContainer)
        {
        ...
        private IEnumerable<FieldInfo> GetNonSimpleFields(object fieldsContainer)
        {
